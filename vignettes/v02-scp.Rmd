...
```{r, echo=FALSE}
# save(lcb3, file = file.path("../data/exercise1.rda"), 
...
```{r, echo = FALSE}
# save(remove.duplicates, peptideAssays, lcb3, 
#      file = file.path("../data/exercise2.rda"), 
#      compress = "xz", compression_level = 9)
```
...
```{r, echo = FALSE}
# save(lcb3, file = file.path("../data/exercise3.rda"), 
#      compress = "xz", compression_level = 9)
```
...
```{r, echo = FALSE}
# save(lcb3, sce, 
#      file = file.path("../data/exercise4.rda"), 
#      compress = "xz", compression_level = 9)
```
...
```{r, echo = FALSE}
# save(lcb3, file = file.path("../data/exercise5.rda"), 
#      compress = "xz", compression_level = 9)
```
