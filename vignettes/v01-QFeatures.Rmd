...
generally obtained after running a preprocessing algorithm on MS 
spectra. This algorithm matches the spectra to a peptide database to 
infer the peptide sequence from which the spectra originated. Spectra
for which a corresponding peptide could be found are called peptide to
spectrum matches (PSMs). The intensities recorded by the MS are then 
